...
class CounterMistakes:
    def __init__(self, id_user):
        ...
        self.file_counter = 0
        self.mistakes_names= ["Missing abstract method implementations", "Diamond inheritance problem", "Not using the super() function", "Problem with the polymorphism", "Static variable issue", "Complex inheritance hierarchy"]
    ...
    def write_to_csv(self):
        ...
        df.loc[0] = [self.id_user]+[self.dict_mistakes[mistake] for mistake in self.mistakes_names]+[self.file_counter]+[self.tan]
